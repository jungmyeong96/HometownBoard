...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) //JPA를 사용하기 위해 WebMVCTest대신 사용
public class PostsApiControllerTest {

    @LocalServerPort // 랜덤포트
    private int port;
    ...
    public void testSetPosts() throws Exception {
        ...
        //when
        mvc.perform(post(url) //생성된 목을 통해 API 테스트
